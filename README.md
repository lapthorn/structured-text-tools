...
| `tr` | Translate or delete characters, and squeeze repeated ones. See `man 1 tr` on your system ([GNU](http://linux.die.net/man/1/tr), [FreeBSD](https://www.freebsd.org/cgi/man.cgi?query=tr&sektion=1)). |
